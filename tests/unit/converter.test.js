...
test('Convert 1000 THB to BTC', () => {
  ...
  // Calculate expected value: 1000 THB * 0.027 USD/THB / 45000 USD/BTC
...
test('Convert 50 USD to THB', () => {
  ...
  // Calculate expected value: 50 USD * 1.0 / 0.027 USD/THB
...
test('Convert 0.01 BTC to USD', () => {
  ...
  // Calculate expected value: 0.01 BTC * 45000 USD/BTC / 1.0
